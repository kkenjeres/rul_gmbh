  ...
  return (
    <article className="m-auto w-[80%] py-20">
      ...
      <p className="font-spaceGrotesk">
        ...
        Person sind.„Verarbeitung“ ist jeder mit oder ohne Hilfe automatisierter
        Verfahren ausgeführte Vorgang oder jede solche Vorgangsreihe im
        Zusammenhang mit personenbezogenen Daten. Der Begriff reicht weit und
        umfasst praktisch jeden Umgang mit Daten.„Pseudonymisierung“ die
        ...
        vorherzusagen.Als „Verantwortlicher“ wird die natürliche oder
        ...
        nicht genannt wird, Folgendes: Die Rechtsgrundlage für die Einholung von
        ...
        Interessen ist Art. 6 Abs. 1 lit. f DSGVO. Die Verarbeitung von Daten zu
        anderen Zwecken als denen, zu denen sie erhoben wurden, bestimmt sich
        ...
        Voreinstellungen. Zusammenarbeit mit Auftragsverarbeitern, gemeinsam
        Verantwortlichen und Dritten Sofern wir im Rahmen unserer Verarbeitung
        Daten gegenüber anderen Personen und Unternehmen (Auftragsverarbeitern,
        gemeinsam Verantwortlichen oder Dritten) offenbaren, sie an diese
        ...
        etc.). Sofern wir Daten anderen Unternehmen unserer Unternehmensgruppe
        ...
        entsprechenden Grundlage. Übermittlungen in Drittländer Sofern wir Daten
        ...
        auf Grundlage besonderer Garantien, wie z.B. vertraglicher Verpflichtung
        ...
        Rechte der betroffenen Personen Auskunftsrecht: Sie haben das Recht,
        ...
        und Kopie der Daten entsprechend den gesetzlichen Vorgaben.Recht auf
        ...
        Berichtigung der Sie betreffenden unrichtigen Daten zu verlangen.Recht
        ...
        anderen Verantwortlichen zu fordern.Beschwerde bei Aufsichtsbehörde: Sie
        haben ferner nach Maßgabe der gesetzlichen Vorgaben das Recht, eine
        Beschwerde bei der zuständigen Aufsichtsbehörde einzureichen.
        Widerrufsrecht Sie haben das Recht, erteilte Einwilligungen mit Wirkung
        für die Zukunft zu widerrufen. Widerspruchsrecht Widerspruchsrecht: Sie
        ...
        Direktwerbung in Verbindung steht. Cookies und Widerspruchsrecht bei
        Direktwerbung Als „Cookies“ werden kleine Dateien bezeichnet, die auf
        ...
        einem Customer-Relationship-Management System (&quot;CRM System&quot;)
        oder vergleichbarer Anfragenorganisation gespeichert werden.Wir löschen
        die Anfragen, sofern diese nicht mehr erforderlich sind. Wir überprüfen
        ...
        einheitlich bezeichnet als “Inhalte”). Dies setzt immer voraus, dass die
        ...
        mit solchen Informationen aus anderen Quellen verbunden werden. Google
        Fonts Wir binden die Schriftarten (&quot;Google Fonts&quot;) des
        Anbieters Google Ireland Limited, Gordon House, Barrow Street, Dublin 4,
        Irland, ein. Nach Angaben von Google werden die Daten der Nutzer allein
        ...
        https://www.google.com/policies/privacy/. Google Maps Wir binden die
        Landkarten des Dienstes “Google Maps” des Anbieters Google Ireland
        Limited, Gordon House, Barrow Street, Dublin 4, Irland, ein. Zu den
        verarbeiteten Daten können insbesondere IP-Adressen und Standortdaten
        der Nutzer gehören, die jedoch nicht ohne deren Einwilligung (im
        ...
        https://adssettings.google.com/authenticated. Typekit-Schriftarten von
        Adobe Wir setzen auf Grundlage unserer berechtigten Interessen (d.h.
        Interesse an der Analyse, Optimierung und wirtschaftlichem Betrieb
        unseres Onlineangebotes im Sinne des Art. 6 Abs. 1 lit. f. DSGVO)
